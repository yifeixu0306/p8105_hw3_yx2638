...
2595176 observations. Key variables inlude id, year, month, day, prcp,
snow, snwd, tmax, tmin. The unit for precipitation, snowfall and snow
depth is unified as “mm”, while the unit for maximum temperature `tmax`
and minimum temperature `tmin` which maximum temperature and minimum
...
minimum temperature, accounting for 5.62%, 14.69%, 22.80%, 43.71%,
43.71%respectively.
