...
We cannot observe apparent trend from the table. However, compared with weekends, total activity counts are more stable during weekdays and it's obvious that the total activity accounts on Saturdays in week 4 and week 5 is far lower than any other days. 
